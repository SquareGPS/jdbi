...
public class DBI implements IDBI {
    ...
    @Override
    public <SqlObjectType> SqlObjectType open(Class<SqlObjectType> sqlObjectType, SqlObjectPlugin ... plugins) {
        return SqlObjectBuilder.open(this, sqlObjectType, plugins);
    }
    ...
    @Override
    public <SqlObjectType> SqlObjectType onDemand(Class<SqlObjectType> sqlObjectType, SqlObjectPlugin ... plugins) {
        return SqlObjectBuilder.onDemand(this, sqlObjectType, plugins);
    }
